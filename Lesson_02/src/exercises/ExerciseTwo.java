...
public class ExerciseTwo 
{
	public static void main(String[] args) 
	{
		 ...
		 if(rightMotorMovingForward == leftMotorMovingForward);
		 {
			 movingStatus = "Robot is moving foward";
		 }
	     if(rightMotorMovingForward && leftMotorMovingForward);
		 {
			 movingStatus = "Robot is spinning to the left";
		 }
		 if(rightMotorMovingForward != rightMotorMovingBackward);
		 {
			 movingStatus = "Robot is staying still"; 
		 }
		 {
		 if(rightMotorNotMoving && leftMotorNotMoving)
		 {
			...
			else if(leftMotorMovingBackward == rightMotorMovingBackward)
			{
				movingStatus = "Robot is moving backwards";
			}
		 
		 else if(leftMotorMovingBackward != rightMotorMovingForward);
			movingStatus = "Robot not working";
		 }
		 {
